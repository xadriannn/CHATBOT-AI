export async function askAI(systemPrompt, userMessage, GROQ_API_KEY) {
  const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
    ...
    body: JSON.stringify({
      model: "llama-3.1-8b-instant", // Ganti ke model gratis Groq
      messages: [
  ...
  // Tambahkan info Kominfotik
  const contactInfo = `
<br><br>Untuk info lebih lanjut Mengenai Kominfotik Jakarta Timur:
...
▶️ Youtube: www.youtube.com/@KotaJakartaTimur`;
  ...
  // Ubah markdown bold ke HTML dan ganti newline jadi <br>
