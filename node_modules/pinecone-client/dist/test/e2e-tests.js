 ...
 */
export async function e2eTests(pinecone) {
    const vectors = {
        1: {
            id: '1',
            values: [1, 1, 1, 1],
    ...
    assert(typeof r2.matches[0]?.score === 'number', 'Expected score to be a number');
    assert(typeof r2.matches[1]?.score === 'number', 'Expected score to be a number');
    // Query by vector id
    ...
    assert.deepStrictEqual(v1?.metadata, vectors[1].metadata, 'Metadata should match');
    ...
    assert.deepStrictEqual(v2.sparseValues, vectors[1].sparseValues, 'Sparse values should match');
    ...
    assert.deepStrictEqual(v3.sparseValues, vectors[1].sparseValues, 'Sparse values should match');
    assert.deepStrictEqual(v3?.metadata, vectors[1].metadata, 'Metadata should match');
    ...
    assert.deepStrictEqual(r11.namespaces[NAMESPACE], { vectorCount: 2 }, 'Expected namespace object to match');
    ...
    assert.deepStrictEqual(r12.vectors['1']?.values, [11, 11, 11, 11], 'Values should be updated');
    ...
    assert.deepStrictEqual(r13.vectors['1']?.metadata, {
        count: 11,
        tags: ['a', 'b'],
        approved: true,
    ...
    assert.deepStrictEqual(r14.vectors['3'], {
        id: '3',
        values: [3, 3, 3, 3],
        sparseValues: {
            indices: [2, 12, 22, 32],
