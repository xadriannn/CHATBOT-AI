...
export class PineconeClient {
    ...
    constructor(config) {
        ...
        if (!baseUrl) {
            throw new Error('Missing Pinecone base URL. Please provide one in the config or set the PINECONE_BASE_URL environment variable.');
        }
        this.apiKey = apiKey;
    ...
    async query(params) {
        ...
        if (hybridAlpha != undefined) {
            ...
            if (!vector || !sparseVector) {
                throw new Error(`Hybrid queries require vector and sparseVector parameters.`);
            }
